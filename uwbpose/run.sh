...
python train.py --name 210422_GAN_duel_model3 --batch-size 64 --nepoch 60 --cutoff 256 --gpu-num 1 --flatten --normalize --gamma 0.5 #--arch hrnet


# Valid
#python valid.py --gpu-num 1 --batch-size 32 --nlayer 18 --flatten #--arch hrnet
python valid.py --gpu-num 1 --nlayer 18 --batch-size 64 --cutoff 256 --flatten --normalize #--arch hrnet